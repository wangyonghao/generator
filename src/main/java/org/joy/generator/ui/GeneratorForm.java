...
import org.joy.dbutils.Database;
import org.joy.dbutils.DatabaseFactory;
...
import org.joy.generator.config.model.DatabaseElement;
import org.joy.generator.ui.component.EditableTable;
import org.joy.generator.ui.task.CloseConnectionTask;
import org.joy.generator.ui.task.TaskListener;
...
public class GeneratorForm extends JFrame {
    ...
    public GeneratorForm() {
        ...
        menuItemExit.addActionListener(e -> onExitActionPerformed());

        mntmConnect = new JMenuItem("Connect...");
        mntmConnect.addActionListener(e -> onConnectActionPerformed());
        mnNewMenu.add(mntmConnect);

        mntmDisconnect = new JMenuItem("DisConnect");
        mntmDisconnect.addActionListener(e -> disConnection());
        ...
        mntmTableInfo.addActionListener(e -> loadDatabaseTable());
        ...
        btnGenerate.addActionListener(e -> onGenerateActionPerformed());
    ...
    private JPanel buildLeftPane() {
        ...
        tableSearchField.addCaretListener(e -> {
    ...
    private void onConnectActionPerformed() {
        ...
        if (dbManagementDialog.getReturnStatus() == DbManagementDialog.RET_OK && databaseElement != null) {
            try {
                disConnection();
                connection = Database.getConnection(databaseElement.getDriverClass(), databaseElement.getConnectionUrl(), databaseElement.getUsername(), databaseElement.getPassword());
                if (connection != null) {
    ...
    private void drawTableGrid() {
        ...
        tableGrid.setComboCell(IDX_COLUMN_JAVATYPE, new org.joy.generator.ui.component.ComboBoxEditor(typeMapping.getAllJavaTypes()));// 第2列为下拉
    ...
    private void onGenerateActionPerformed() {
        GenerationDialog generationDialog = new GenerationDialog(configuration, tableModel);
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(() -> {
            try {
                ...
                GeneratorForm frame = new GeneratorForm();
