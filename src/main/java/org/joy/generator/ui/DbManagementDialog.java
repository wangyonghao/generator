...
import org.joy.generator.config.JdbcDrivers;
import org.joy.generator.config.model.DatabaseElement;
import org.joy.generator.config.model.DriverInfo;
...
public class DbManagementDialog extends JDialog {
    ...
    private DatabaseElement doConnecting(String name, String driverClass, String connectionUrl, String username, String password,
        ...
        try {
            ...
            conn = Database.getConnection(driverClass,connectionUrl,username,password);
            if (conn != null) {
                if (testing) {
